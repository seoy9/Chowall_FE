...
class ListChunFragment : Fragment() {
    ...
    private fun initRecycler() {
        ...
        datas.apply {
            ...
            add(ListData(img = R.drawable.ex_img_list, name = "델모니코스", address = "강원도 춘천시 동면 순환대로 1154-106", time = "11:00-22:00" ))
            add(ListData(img = R.drawable.ex_img_list, name = "남부닭갈비", address = "강원도 춘천시 공지로 357", phone = "033-243-9966", time = "매일 17:00-22:00" ))
            add(ListData(img = R.drawable.ex_img_list, name = "라모스버거", address = "강원도 춘천시 옛경춘로 835" ))
